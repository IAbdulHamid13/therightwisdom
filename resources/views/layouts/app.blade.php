...
<head>
    ...
    <title>@yield('title', 'The Right Wisdom')</title>
    <script src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js" defer></script>
    @vite(['resources/css/templatestyle.css'])
    @yield('styles')
</head>
        ...
        <div class="rounded-menu">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    <a href="{{ route('services.dental') }}">Dental</a>
                    <a href="{{ route('services.psychiatry') }}">Psychiatry</a>
                    <a href="{{ route('services.psychology') }}">Psychology</a>
                    <a href="#medical" class="disabled">Medical (Under Construction)</a>
                </div>
            </div>
            <a href="#insurance">Insurance & Financing</a>
            <a href="#call-now">Contact</a>
